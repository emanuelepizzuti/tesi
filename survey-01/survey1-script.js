...
swiper.on('slideChange', function() {
  ...
  if (this.activeIndex === 1) {
    $(".bottom-navigation").addClass("noncliccabile");
    ...
    const mouseMoveHandler = function(e) {
      ...
      if (newLeftWidth >= 0 & newLeftWidth < 25) {
        ...
        $(".knob").css('background', 'radial-gradient(50% 50% at 50% 50%, #18C3B2 0%, rgba(24, 195, 178, 0) 100%)');
        answ2 = "1";
      } else if (newLeftWidth >= 25 & newLeftWidth < 50) {
        $("#domanda-risposta2").html("Meno di 5");
        $(".knob").css('background', 'radial-gradient(50% 50% at 50% 50%, #66A69D 0%, rgba(102, 166, 157, 0) 100%)');
        answ2 = "2";
      } else if (newLeftWidth >= 50 & newLeftWidth < 75) {
        $("#domanda-risposta2").html("Tra 5 e 10");
        $(".knob").css('background', 'radial-gradient(50% 50% at 50% 50%, #B38988 0%, rgba(179, 137, 136, 0) 100%)');
        answ2 = "3";
      } else if (newLeftWidth >= 70 & newLeftWidth <= 100) {
        $("#domanda-risposta2").html("Più di 10");
        $(".knob").css('background', 'radial-gradient(50% 50% at 50% 50%, #FE6D73 0%, rgba(254, 109, 115, 0) 100%)');
        answ2 = "4";
      }
  ...
  ////// INIZIO DOMANDA 3 //////
    ...
    const mouseMoveHandler = function(e) {
      ...
      if (newLeftWidth >= 0 & newLeftWidth < 33) {
        ...
        $(".knob").css('background', 'radial-gradient(50% 50% at 50% 50%, #E0FBFC 0%, rgba(224, 251, 252, 0) 100%)');
        answ3 = "1";
      } else if (newLeftWidth >= 33 & newLeftWidth < 66) {
        $("#domanda-risposta3").html("Non so");
        $(".knob").css('background', 'radial-gradient(50% 50% at 50% 50%, #84969E 0%, rgba(132, 150, 158, 0) 100%)');
        answ3 = "2";
      } else if (newLeftWidth >= 66 & newLeftWidth <= 100) {
        $("#domanda-risposta3").html("Si");
        $(".knob").css('background', 'radial-gradient(50% 50% at 50% 50%, #2A3342 0%, rgba(42, 51, 66, 0) 100%)');
        answ3 = "3";
      }
  ...
  ////// INIZIO DOMANDA 4 //////
    ...
    $(".bottonefinalone").addClass("noncliccabile");
    ...
    const mouseMoveHandler = function(e) {
      ...
      $(".bottonefinalone").removeClass("noncliccabile");
    };
